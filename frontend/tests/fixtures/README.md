...
| `FX-DEBT-RECEIVABLES-01` | Money owed across debtors | Debts 9904–9908, all INGRESS; total outstanding 2,050.00 over 4 active debts and 3 debtors; Contact 9504 owes 1,200.00, Contact 9503 owes 750.00 across two debts, debt 9907 has no Contact and owes 100.00; debt 9906 is settled and excluded. Counterpart keys are `in-contact-9504`, `in-contact-9503`, `in-debt-9907` | 3C |
| `FX-DEBT-BIDIRECTIONAL-01` | Debts in both directions | Debts 9910–9914; owed to the User 400.00 over 1 debt and 1 counterpart, owed by the User 1,500.00 over 3 debts and 3 counterparts; Contact 9503 appears on both sides (`in-contact-9503` 400.00, `out-contact-9503` 750.00) and is never netted; debt 9914 owes 250.00 with no Contact (`out-debt-9914`); debt 9913 is settled and excluded | ADR-0023 |
...
The receivables fixture also supplies Contacts, a long-name Trash item, and debt 9904 with payment 9708 linking to transaction 9612 for read-only browser navigation checks. The bidirectional fixture supplies debt 9911 with payment 9710 so the detail page can be driven for a Debt the User owes, Categories in both Directions so a Direction-filtered Category picker is never empty, and Boxes 9210 (500.00) and 9211 (0.00) so the Box funding editor has both a fundable and an empty Box.
