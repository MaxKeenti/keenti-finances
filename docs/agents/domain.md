...
- **`CONTEXT.md`** at the repo root — the project's domain glossary. Use its vocabulary in any output that names a domain concept.
...
Single-context repo: one domain (personal finance) spanning a Quarkus backend and a SvelteKit frontend.

```
/
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-hexagonal-backend-architecture.md
│   └── ...
├── backend/
└── frontend/
```
