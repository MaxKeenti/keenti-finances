...
- [X] **Billing trigger:** In a shared subscription, the "Generate Bills" action creates payment records for members
- [X] **Debt tracking:** Create a debt, record a payment, verify balance updates
